...
import space.nerdsin.plugins.enhancedchat.services.GeneralPlayerService;
...
@Singleton
public class JoinLeaveListener implements IPluginListener {
  ...
  @Inject
  public JoinLeaveListener(PlayerService players, GeneralPlayerService general,
