...
import space.nerdsin.plugins.enhancedchat.EnhancedChatPlugin;
...
import space.nerdsin.plugins.enhancedchat.util.IServiceProvider;
...
public class PlayerService implements IServiceProvider {
	...
	@Inject
  public PlayerService(PluginConfiguration config, EnhancedChatPlugin plugin, IgnoringService ignoringService, WhisperService whisperService) {
